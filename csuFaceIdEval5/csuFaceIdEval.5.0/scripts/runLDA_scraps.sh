...
run csuSubspaceTrain -lda -imDir data/csuScrapShots/normSep2002sfi imagelists/scrap_all.srt train/scraps/scrapsLDA.train
...
run csuSubspaceProject -imDir data/csuScrapShots/normSep2002sfi train/scraps/scrapsLDA.train imagelists/scrap_all_x4.srt distances/scraps/LDA_ldaSoft ldaSoft
